...
<div class="wrapper">
	<div class="head font14 lineh50">
		...
		<!-- 样式定义尽量共用且易读 -->
		<!-- 书写行内标签即可 a或span均可以 -->
		<a class="pad-r-5"  href="/xijing/project/modules/home/index.jsp">首页</a>
		>
		<a class="pad-lr-5" href="javascript:void(0);">网上预约</a>
		>
		<a class="pad-l-5" href="javascript:void(0);">临床免疫科</a>
	</div>
